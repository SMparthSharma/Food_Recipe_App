...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        leading: IconButton(onPressed: (){}, icon: Icon(Icons.menu_rounded,size: 32.0,),),
        backgroundColor: kLightColor,
        actions: [
          IconButton(onPressed: (){},
          icon: Icon(Icons.notifications_outlined,size: 32.0,))],),
      body:SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 5.0,),
              Text('Welcome',style: TextStyle(fontSize: 16.0,color: Colors.grey),),
              SizedBox(height: 10.0,),
              Text('What would you like to cook today?',style: TextStyle(fontFamily: 'Hellix-Bold',fontWeight: FontWeight.bold,fontSize: 25.0),),
              SizedBox(height: 10.0,),
              Row(
                children: [
                  Expanded(
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: (){},
                      child: Image.asset('assets/images/settings.png',height: 22.0,),
                    ),
                  )
                ],
              ),
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(
                    ...
                    style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.bold,fontFamily: 'Hellix-Bold'),
                    ),
                  GestureDetector(
                    onTap: (){print("object");},
                    child: Text(
                      "See All",
                      style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold,fontFamily: 'Hellix-Bold',color: kOrangeColor),
                    ),
                  ),
                ],
              ),
                                          ...
                                          Positioned(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  Text("Breakfast",style: TextStyle(fontFamily: 'Hellix-bold',fontSize: 15.0,color: kBlueColor),),
                                                  SizedBox(height: 8.0,),
                                                  Container(
                                                      width: 180.0,
                                                      child: Text("Burger",overflow: TextOverflow.ellipsis,style: TextStyle(fontFamily: 'Hellix-bold',fontSize: 20.0,color: kDarkColor,fontWeight: FontWeight.bold))),
                                                  SizedBox(height: 8.0,),
                                                  Row(
                                                    children:
                    List.generate(5, (index)=>Icon(Icons.star,size: 20.0,color: Colors.amber[700],),)
                                                    ,
                                                  ),
                                                  SizedBox(height: 8.0,),
                                                  Row(
                                                    children: [
                    Icon(Icons.fireplace_outlined,color: Colors.grey,size: 15,),
                    SizedBox(width: 5,),
                    Text("500 calories",style: TextStyle(fontFamily: 'Hellix-bold',fontSize: 14.0,color: kOrangeColor)),
                                                    ],
                                                  )
